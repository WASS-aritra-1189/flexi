...
import { getTravelPartners } from "../../store/slice/partnerSlice";
...
const TravelPartner = () => {
    ...
    const { travelPartners, travelPartnerTotal } = useSelector((state) => state.partner);
    ...
    useEffect(() => {
        dispatch(getTravelPartners({ limit: paginationState.limit, offset: paginationState.offset, keyword: paginationState.keyword }));
    ...
    return (
        <>
            ...
            <Pagination
                ...
                totalItem={travelPartnerTotal || 0}
                limitSelect={true}
            ...
            <Modal isOpen={detailsModal} onClose={() => setDetailsModal(false)} title="Travel Partner Details" width="600px">
                {selected && (
                    <div className="details-content">
                        ...
                        {selected.travelPartnerAmenity?.length > 0 && (
                            <div className="detail-item">
                                <label>Amenities:</label>
                                <span>{selected.travelPartnerAmenity.map(a => a.propertyAmenity?.name).join(", ")}</span>
                            </div>
                        )}
                    </div>
                )}
